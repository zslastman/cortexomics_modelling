...
I do think I need to seperate the techical and biological variance though....
...
This is still the exponential parametrization. The linear one might be tricker...
...
prot + log2(mydbs %*% ((fcs(prot)) + Kd)) - lKs
